...
public class BatchDemo extends BaseJunit {
	 ...
	 * redisTemplate.opsForList().leftPush("product:list", "HuaWei Mate20X",
	 * "xiaomi mix");
	 * }
	 ...
	 * redisTemplate.opsForList().remove("product:list", -1,
	 * "HuaWei Mate20 pro");
	 * }
	 * @Test
	 * public void demo8() {
	 ...
	 * Object value = redisTemplate.opsForList().index("product:list", 1);
	 * System.out.println(value);
	 * }
	 * @Test
	 * public void demo9() {
	 * //查询list中指定范围的内容
	 * List<String> list = redisTemplate.opsForList().range("product:list", 0,
	 * -1);
	 ...
	 * //弹出k1最右边元素并放入k2最左边
	 * redisTemplate.opsForList().rightPopAndLeftPush("product:list",
	 * "game:list");
	 * }
	 */
}
