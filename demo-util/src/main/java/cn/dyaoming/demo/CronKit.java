...
public class CronKit {
	...
	*/
	...
	public static void main(String[] args) {
		...
		// CronKit cron = new CronKit("0 0 1 1 * ? *");
		CronKit cron = new CronKit("0/5 * * * * ? *");
//		System.out.println(padLeft(Long.toBinaryString(cron.getCrop(0)),64,'0') + ":秒 ");
//		System.out.println(padLeft(Long.toBinaryString(cron.getCrop(1)),64,'0') + ":分 ");
//		System.out.println(padLeft(Long.toBinaryString(cron.getCrop(2)),64,'0') + ":时 ");
//		System.out.println(padLeft(Long.toBinaryString(cron.getCrop(3)),64,'0') + ":天 ");
//		System.out.println(padLeft(Long.toBinaryString(cron.getCrop(4)),64,'0') + ":月 ");
//		System.out.println(padLeft(Long.toBinaryString(cron.getCrop(5)),64,'0') + ":周 ");
//		System.out.println(padLeft(Long.toBinaryString(cron.getCrop(6)),64,'0') + ":年 ");
		for (int i = 0; i < 60; i++) {
